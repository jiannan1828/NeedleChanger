    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            #if (true) 
            {
                ...
                int Get = (int)MotorControl.InitWMX3();
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
            {
        ...
        private void strCommunication_Click_1(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.StartWMX3();
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void stoCommunication_Click_1(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.StopWMX3();
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void svOn0_Click(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.SetWMX3_MotorIndex(0);
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void svOn1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.SetWMX3_MotorIndex(1);
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void svOff0_Click_1(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.ClsWMX3_MotorIndex(0);
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void svOff1_Click(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.ClsWMX3_MotorIndex(1);
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.VelocityWMX3_MotorIndex(0, 100000, 10000, 10000);
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
        ...
        private void button2_Click_2(object sender, EventArgs e)
        {
            ...
            {
                PublicClass_MotorControl MotorControl = new PublicClass_MotorControl();
                int Get = (int)MotorControl.VelocityWMX3_MotorIndex(0, 0, 0, 0);
                Get = Get + 1;
                this.button1.Text = Get.ToString();
            }
            #else
